...
export const idlService = IDL.Service({
  ...
  'addItem' : IDL.Func([EquipmentItem], [IDL.Nat], []),
  ...
  'getItems' : IDL.Func([], [IDL.Vec(EquipmentItem)], ['query']),
  'getNextItemId' : IDL.Func([], [IDL.Nat], ['query']),
  ...
  'setHomepageContent' : IDL.Func([HomepageContent], [IDL.Bool], []),
  'updateItem' : IDL.Func([EquipmentItem], [IDL.Bool], []),
});
